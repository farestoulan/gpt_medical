import '../../../chat/data/models/medical_condition.dart';
...
class MedicalKnowledge {
  ...
  static List<MedicalCondition> getConditionsByCategory(String category) {
    return conditions
        .where((condition) => condition.category == category)
        .toList();
  }
    ...
    return conditions
        .where(
          (condition) =>
              ...
              condition.symptoms.any(
                (symptom) => symptom.toLowerCase().contains(lowerQuery),
              ) ||
              condition.treatments.any(
                (treatment) => treatment.toLowerCase().contains(lowerQuery),
              ),
        )
        .toList();
  }
  ...
  static List<MedicalCondition> getConditionsBySeverity(String severity) {
    return conditions
        .where((condition) => condition.severity == severity)
        .toList();
  }
