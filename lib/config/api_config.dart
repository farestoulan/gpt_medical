class ApiConfig {
  ...
  static const String visionEndpoint = '/v1/images:annotate';
...
''';
  ...
  // Error Messages
  static const String networkError = 'خطأ في الاتصال بالشبكة. يرجى المحاولة مرة أخرى.';
  static const String apiError = 'خطأ في الخدمة. يرجى المحاولة لاحقاً.';
  static const String imageError = 'خطأ في معالجة الصورة. يرجى المحاولة مرة أخرى.';
  static const String timeoutError = 'انتهت مهلة الطلب. يرجى المحاولة مرة أخرى.';
